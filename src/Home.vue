...
import { NSpace, NTooltip, NSkeleton } from 'naive-ui'
</script>
  ...
  <div>
    <n-space vertical>
      ...
      <p style="text-align: center;">
        ...
        <n-tooltip trigger="hover"><template #trigger><a href="javascript:void(0)">Mail </a></template>immccn123|at|outlook|dot|com</n-tooltip><br>
